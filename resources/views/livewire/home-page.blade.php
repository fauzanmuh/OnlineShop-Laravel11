<div>
    <div class="w-full h-screen bg-gradient-to-r from-green-200 to-green-400 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-green-600">Tokopaido</span></h1>
    ...
    {{-- Brand Section --}}
    <div class="bg-fuchsia-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200"> Browse Popular<span class="text-green-500">
                            Brands
                        </span> </h1>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Berbagai macam brand popoler di Tokopaido
                </p>
            </div>
        </div>
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                ...
                <div class="bg-gray-100 rounded-lg shadow-md dark:bg-gray-800">
                    <a href="" class="">
    ...
    {{-- Kategori Section --}}
    <div class="bg-indigo-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200"> Browse <span class="text-green-500"> Categories
                        </span> </h1>
                    <div class="flex w-40 mt-4 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-green-200">
                        </div>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Terdapat berbagai macam kategori mulai dari Laptop, Hp, dll
                </p>
            </div>
        </div>
    ...
    {{-- CUSTOMER REVIEWS --}}
    <section class="py-14 font-poppins bg-gradient-to-l from-green-200 to-green-400 dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
          <div class="max-w-xl mx-auto">
            <div class="text-center ">
              <div class="relative flex flex-col items-center">
                <h1 class="text-5xl font-bold dark:text-gray-200"> Customer <span class="text-green-500"> Reviews
                  </span> </h1>
